      ...
      <div className="bg-navy pt-24 pb-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/70 mt-2 max-w-xl mx-auto">
            Market updates, buyer guides, and expert perspectives on Indian real estate.
          </p>
        </div>
      </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-8">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 h-10 border border-input rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-ring"
            />
          </div>
