...
const whyUs = [
  {
    icon: "🏆",
    title: "Curated Projects Only",
    desc: "We partner exclusively with RERA-registered developers with proven track records.",
  },
  {
    icon: "🔍",
    title: "100% Transparency",
    desc: "No hidden charges. Full documentation support. What you see is what you pay.",
  },
  {
    icon: "🤝",
    title: "End-to-End Support",
    desc: "From site visits to home loan assistance to registration — we're with you at every step.",
  },
  {
    icon: "📱",
    title: "Tech-Enabled Experience",
    desc: "Virtual tours, digital documentation, and real-time project updates at your fingertips.",
  },
];
...
const areaCards = [
  {
    name: "Mathura",
    slug: "mathura",
    desc: "Spiritual & serene. Rising real estate destination.",
    image: "https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=600",
  },
  {
    name: "Noida",
    slug: "noida",
    desc: "IT hub with world-class infrastructure & connectivity.",
    image: "https://images.unsplash.com/photo-1486325212027-8081e485255e?w=600",
  },
  {
    name: "Greater Noida",
    slug: "greater-noida",
    desc: "Affordable luxury with metro & expressway access.",
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-screen flex items-center">
        <img
          src={gangotriImg}
          alt="Impyreal Homes Hero"
          className="absolute inset-0 w-full h-full object-cover"
        />
        <div className="absolute inset-0 hero-overlay" />
        <div className="relative container mx-auto px-4 pt-20 pb-16">
          <div className="max-w-3xl">
            <span className="inline-block bg-crimson/90 text-white text-xs font-semibold px-3 py-1.5 rounded-full mb-4 tracking-wider uppercase">
              India's Premium Real Estate Partner
            </span>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-4">
              Curated Homes for an{" "}
              <span className="text-gold">Impyreal</span> Life
            </h1>
            <p className="text-lg text-white/80 mb-8 max-w-xl">
              Discover handpicked residential projects in Mathura, Noida, and Greater Noida —
              crafted for discerning buyers who demand the best.
            </p>
            ...
            <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-4 shadow-2xl">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-3">
                <select
                  ...
                  className="h-11 border border-input rounded-lg px-3 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-ring"
                >
              ...
              <Button
                ...
                className="w-full h-11 bg-crimson hover:bg-crimson-dark text-white font-semibold text-base"
              >
      ...
      <section className="py-16 container mx-auto px-4">
        <div className="flex items-end justify-between mb-8">
          <div>
            <p className="text-crimson text-sm font-semibold uppercase tracking-wider mb-1">
              Our Portfolio
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {whyUs.map((item) => (
              <div
                key={item.title}
                className="bg-white/10 hover:bg-white/15 transition-colors rounded-xl p-6 text-center"
              >
      ...
      <section className="py-16 bg-muted">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            <p className="text-crimson text-sm font-semibold uppercase tracking-wider mb-2">
              Happy Clients
            </p>
            ...
            <div className="flex justify-center gap-2 mt-5">
              {testimonials.map((_, i) => (
                <button
                  ...
                  className={`h-2.5 rounded-full transition-all ${i === testimonialIdx ? "w-6 bg-crimson" : "w-2.5 bg-navy/30"}`}
                />
              ))}
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {areaCards.map((area) => (
            <a
              ...
              className="card-hover relative overflow-hidden rounded-xl h-56 block group"
            >
              <img
                src={area.image}
                alt={area.name}
              ...
              <div className="absolute bottom-0 left-0 p-5">
                ...
                <span className="inline-flex items-center gap-1 text-gold text-xs font-semibold mt-2">
                  Explore Guide <ChevronRight className="h-3 w-3" />
                </span>
              </div>
            </a>
          ))}
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Button
              ...
              className="bg-white text-crimson hover:bg-white/90 font-semibold px-8 h-12 text-base"
            >
