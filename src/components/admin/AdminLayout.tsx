      ...
      <aside className="w-56 bg-navy text-white flex flex-col shrink-0">
        ...
        <div className="p-3 border-t border-white/10">
          <button
            ...
            className="flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm text-white/70 hover:bg-white/10 hover:text-white transition-colors w-full"
          >
          ...
          <Link
            to="/"
            className="mt-1 flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs text-white/40 hover:text-white/60 transition-colors"
          >
            ← Back to Site
          </Link>
        </div>
